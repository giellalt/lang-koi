...
function print_usage() {
    ...
    echo "  -l, --add-langvar   Add env. variable \$GTLANG_koi to login script."
...
# the current dir:
if   test x${GTLANG_koi} = x ; then
	echo "WARNING: The variable \${GTLANG_koi} has not been defined. You"
	...
	echo "$0 -l"
	echo
elif test x${GTLANG_koi} != x${LANGDIR} ; then
	echo "WARNING: The variable \${GTLANG_koi} has the value:"
	echo "  ${GTLANG_koi}"
